...
function startReactApp(){
    ...
    FdmReactTpl.UpdateFfExtensionDialog = ReactDOM.render(
        React.createElement(UpdateFfExtensionDialog),
        document.getElementById('react-update-ff-extension-dialog')
    );
