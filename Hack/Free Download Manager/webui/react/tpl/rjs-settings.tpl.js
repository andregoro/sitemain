...
var UpdateFfExtensionDialog = React.createClass({displayName: "UpdateFfExtensionDialog",
    ...
    getInitialState: function () {
        ...
        var state = {};
        state.opened = app.controllers.settings.model.get('showFFExtensionUpdater');
        state.step = 1;
        state.error = '';
    ...
    _onChange: function() {
        ...
        var state = {};
        state.opened = app.controllers.settings.model.get('showFFExtensionUpdater');
        if (state.opened !== this.state.opened) {
            state.step = 1;
            state.error = '';
        }
        this.setState(state);
    ...
    componentDidMount: function() {
        ...
        app.controllers.settings.model.on('change:showFFExtensionUpdater', this._onChange, this);
    ...
    componentWillUnmount: function() {
        ...
        app.controllers.settings.model.off('change:showFFExtensionUpdater', this._onChange, this);
    ...
    openFirefoxPluginPage: function() {
        fdmApp.settings.openFirefoxPluginPage();
        this.close();
    },

    removeLegacyFfExtension: function() {

        fdmApp.system.removeLegacyFfExtension(this.removeLegacyFfExtensionCallback);
    },

    removeLegacyFfExtensionCallback: function(error) {
        if (!error || error === "") {
            this.setState({
                step: 2
            });
    ...
    addOnclickEvent: function(fn, rel) {
        if (!rel) {
            return;
        }
        const aa = rel.getElementsByTagName('a');
        if (aa && aa.length) {
            let a = aa[0];
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "popup__overlay popup_extension", onMouseDown: this.close}, 
                ...
                React.createElement("div", {onMouseDown: stopEventBubble}, 
                    React.createElement("div", {className: "popup"}, 
                        ...
                        React.createElement("div", {className: "header"}, 
                            React.createElement("div", null, __('Firefox extension update')), 
                            React.createElement("div", {className: "close_button", onClick: this.close})
                        ), 

                        React.createElement("div", {className: "center"}, 
                            React.createElement("div", {className: "note"}, __('A new version of the Firefox extension is available')), 

                            React.createElement("div", null, 
                                React.createElement("div", null, __('To update the extension:')), 
                                React.createElement("ul", null, 
                                    React.createElement("li", {className: this.state.step !== 1 ? 'disabled' : null, ref: this.addOnclickEvent.bind(this, this.removeLegacyFfExtension), 
                                        dangerouslySetInnerHTML: {__html: '1) ' + __('Click %1 to remove the old version.', '<a href="#">' + __('here') + '</a>')}}), 
                                    React.createElement("li", {className: this.state.step !== 2 ? 'disabled' : null, ref: this.addOnclickEvent.bind(this, this.openFirefoxPluginPage), 
                                        dangerouslySetInnerHTML: {__html: '2) ' + __('%1 the new version.' + (this.state.step === 2 ? '*' : ''), '<a href="#">' + __('Install') + '</a>')}})
                                ), 

                                this.state.step === 2 ?
                                    React.createElement("span", {className: 'info' + (this.state.step !== 2 ? ' disabled' : '')}, '* ' + __('Before that, restart Firefox if it\'s running.'))
                                        : null, 
                                this.state.step === 1 && this.state.error.length ?
                                    React.createElement("span", {className: "info error"}, 
                                        React.createElement("span", null, __('Error while removing:') + ' ' + this.state.error), 
                                        React.createElement("span", null, __('Close Firefox if it\'s running and try again'))
                                    )
                                        : null
                            )
                        )
...
var Settings = React.createClass({displayName: "Settings",
    ...
    changeChooseTheme:function(event){

        app.controllers.settings.model.set({chooseTheme: parseInt(event.target.value)});
    },
        ...
        if (s.languageMenuOpened)
        {
            ...
            if (o)
            {
                ...
                if (e && e.length)
                {
                    ...
                    if (s.languageMenuTopPos) {
                        s.languageListMaxHeight = rect.top - 70;
                    } else {
                        s.languageListMaxHeight = window.innerHeight - rect.top - rect.height - 50;
                    }
                }
            }
        }
    ...
    render: function() {
        ...
        return (
            ...
            React.createElement("div", {className: "settings_wrapper"}, 
                ...
                React.createElement("div", {className: "right_panel", id: "settings_right_panel", onScroll: this.settingsOnScroll}, 
                    ...
                    React.createElement("div", {className: "general_tab"}, 
                        ...
                        this.showBlock({
                            ...
                            React.createElement("div", {className: "downloads_tab"}, 
                                React.createElement("div", {className: "tab_title"}, this.settingsText('Choose theme')), 
                                React.createElement("div", {className: "wrap_group"}, 

                                    React.createElement("input", {name: "chooseTheme", 
                                           checked: this.state.chooseTheme === fdm.models.chooseThemeValues.Light, 
                                           defaultChecked: this.state.chooseTheme === fdm.models.chooseThemeValues.Light, 
                                           value: fdm.models.chooseThemeValues.Light, 
                                           onChange: this.changeChooseTheme, 
                                           type: "radio", id: "chooseThemeLight"}), 
                                    React.createElement("label", {htmlFor: "chooseThemeLight"}, this.settingsText('Light')), 

                                    React.createElement("input", {name: "chooseTheme", 
                                           checked: this.state.chooseTheme === fdm.models.chooseThemeValues.Dark, 
                                           defaultChecked: this.state.chooseTheme === fdm.models.chooseThemeValues.Dark, 
                                           value: fdm.models.chooseThemeValues.Dark, 
                                           onChange: this.changeChooseTheme, 
                                           type: "radio", id: "chooseThemeDark"}), 
                                    React.createElement("label", {htmlFor: "chooseThemeDark"}, this.settingsText('Dark'))
                                ...
                                React.createElement("div", {className: "choose bottom"}, 
                                    ...
                                    React.createElement("div", {onClick: this.languageMenuToggle, 
                                        ...
                                        React.createElement("div", {className: "list", 
                                             style: {display: this.state.languageMenuOpened ? 'block' : 'none', maxHeight: this.state.languageListMaxHeight}}, 
                            ...
                            React.createElement("div", null, 
                                ...
                                React.createElement("div", {className: "wrap_group"}, 
                                    ...
                                    this.showBlock({
                                        ...
                                        React.createElement("div", null, 
                                            React.createElement("input", {checked: s['show-special-offers'], 
                                                   defaultChecked: s['show-special-offers'], onChange: _.partial(this.changeSetting, 'show-special-offers'), 
                                                   type: "checkbox", id: "с-show-special-offers"}), 
                                            React.createElement("label", {htmlFor: "с-show-special-offers"}, this.settingsText('Show special offers'))
                                        )
                                        : null, 
