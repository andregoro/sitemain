                    ...
                    { !this.state.showSelectedList && this.state.currentItemId ?
                        <ul className="tabs">
                            ...
                            <li style={{display: is_trt || is_batch ? 'inline-block' : 'none'}}
                                ...
                                onMouseDown={_.partial(this.changeTab, fdm.views.BottomPanelTab.Files)}>{__('Files') + (files_count > 0 ? ' (' + files_count + ')' : '')}</li>
    ...
    render: function() {
        ...
        return (
            ...
            <li className={rjs_class({
                ...
                <div className="yt_preview_wr">
                    <img src={download.getThumbnailUrl('bottom-panel')} alt="" />
                </div>
