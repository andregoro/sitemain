...
var UpdateFfExtensionDialog = React.createClass({
    ...
    render: function() {
        ...
        return (
            <div className="popup__overlay popup_extension" onMouseDown={this.close}>
                <div className="mount"></div>
                <div onMouseDown={stopEventBubble}>
                    <div className="popup">

                        <div className="header">
                            <div>{__('Firefox extension update')}</div>
                            <div className="close_button" onClick={this.close} />
                        </div>

                        <div className="center">
                            <div className="note">{__('A new version of the Firefox extension is available')}</div>

                            <div>
                                <div>{__('To update the extension:')}</div>
                                <ul>
                                    <li className={this.state.step !== 1 ? 'disabled' : null} ref={this.addOnclickEvent.bind(this, this.removeLegacyFfExtension)}
                                        dangerouslySetInnerHTML={{__html: '1) ' + __('Click %1 to remove the old version.', '<a href="#">' + __('here') + '</a>')}} />
                                    <li className={this.state.step !== 2 ? 'disabled' : null} ref={this.addOnclickEvent.bind(this, this.openFirefoxPluginPage)}
                                        dangerouslySetInnerHTML={{__html: '2) ' + __('%1 the new version.' + (this.state.step === 2 ? '*' : ''), '<a href="#">' + __('Install') + '</a>')}} />
                                </ul>

                                {this.state.step === 2 ?
                                    <span className={'info' + (this.state.step !== 2 ? ' disabled' : '')}>{'* ' + __('Before that, restart Firefox if it\'s running.')}</span>
                                        : null }
                                {this.state.step === 1 && this.state.error.length ?
                                    <span className="info error">
                                        <span>{__('Error while removing:') + ' ' + this.state.error}</span>
                                        <span>{__('Close Firefox if it\'s running and try again')}</span>
                                    </span>
                                        : null }
                            </div>
                        </div>
    ...
    render: function() {
        ...
        return (
            ...
            <div className="settings_wrapper">
                ...
                <div className="right_panel" id="settings_right_panel" onScroll={this.settingsOnScroll}>
                    ...
                    <div className="general_tab">
                        ...
                        {this.showBlock({
                            ...
                            <div className="downloads_tab">
                                <div className="tab_title">{this.settingsText('Choose theme')}</div>
                                <div className="wrap_group">

                                    <input name="chooseTheme"
                                    ...
                                    <label htmlFor="chooseThemeLight">{this.settingsText('Light')}</label>
                                    ...
                                    <label htmlFor="chooseThemeDark">{this.settingsText('Dark')}</label>
                            ...
                            <div>
                                ...
                                <div className="wrap_group">
                                    ...
                                    {this.showBlock({
                                        ...
                                        <div>
                                            <input checked={s['show-special-offers']}
                                            ...
                                            <label htmlFor="с-show-special-offers">{this.settingsText('Show special offers')}</label>
                                        </div>
                                        : null }
