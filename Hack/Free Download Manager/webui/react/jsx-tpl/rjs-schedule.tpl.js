                ...
                <div className={rjs_class({
                    ...
                    <div className="choose">
                        ...
                        <div className={rjs_class({
                            ...
                            <div className="list" style={{display: this.state.timeStartState != this.selectStates.closed ? 'block' : 'none', maxHeight: this.state.intervalsListMaxHeight + 'px'}}>
                    ...
                    <div className="choose">
                        ...
                        <div className={rjs_class({
                            ...
                            <div className="list" style={{display: this.state.timeEndState != this.selectStates.closed ? 'block' : 'none', maxHeight: this.state.intervalsListMaxHeight + 'px'}}>
