...
// ---- Youtube channel definitions ---- BEGIN ---------------------------
//fdm.models.VideoQualityOptionsForChannel = ['Low', 'Medium', 'High'];
fdm.models.VideoQualityOptionsToVideoFormat = {
    'Low (240p)':       'MP4 240p',
    'Medium (480p)':  'MP4 480p',
    'High (1080p)':     'MP4 1080p'
};

fdm.models.VideoFormatToFileRegexp = [
    { format: "MP4 1080p", regexp: "^\\[MP4 1080p\\]" },
    { format: "MP4 720p", regexp: "^\\[MP4 720p\\]" },
    { format: "MP4 480p", regexp: "^\\[MP4 480p\\]" },
    { format: "MP4 360p", regexp: "^\\[MP4 360p\\]" },
    { format: "MP4 240p", regexp: "^\\[MP4 240p\\]" },
    { format: "MP4 144p", regexp: "^\\[MP4 144p\\]" } 
];

// ---- Youtube channel definitions ---- END ---------------------------
