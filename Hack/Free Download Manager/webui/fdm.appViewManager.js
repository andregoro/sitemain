...
fdm.appViewManager = {
	...
	getDefaultView: function() {
			return {
				...
				settings: {
                    chooseTheme: fdm.models.chooseThemeValues.Light
				}
			}
	},
	init: function(){
    ...
    getSettingsState: function() {
        return this._viewState.settings;
    },

    setSettingsState: function() {

        this._viewState.settings.chooseTheme = window.app.controllers.settings.model.get('chooseTheme');
    },
};