...
//					_.delay(fdm.Events.onMessage, _.random(500, 2000), messageId, imagePath + "?t="+Date.now(), maxWidth, maxHeight);
			...
			getClipboardText: function(){
                            ...
                            //return "https://www.youtube.com/user/HAMAHAtrader/videos"
			},
	...
	function populateLocalization() {
		...
		window.fdmAppFakes.localization = {
			...
			installedTranslations: function(){
				...
				return ["da", "de", "el", "es", "fr", "it", "nl", "pl", "pt", "ro", "ru", "sv", "zh", "en", "ja", "ar", "sl", "vi"];
			},
	...
	function populateApp() {
		...
		window.fdmAppFakes = {
			...
			readViewState: function(){
				var sessionState = localStorage.getItem("viewState");
			...
			writeViewState: function(vsString){
				localStorage.setItem("viewState", JSON.stringify(vsString));
			},
	...
	function initFakeMap(){
      ...
      "http://api/downloadWizard/makeHttpRequest": fdmAppFakes.downloadWizard.makeHttpRequest,
